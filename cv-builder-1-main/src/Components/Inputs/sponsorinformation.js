...
class SponsorInformation extends Component {
                ...
                <h3 style={{marginBottom: 20}}>Sponsor Information & Visa Information</h3>
                    <div className="grid-3-col">
                        ...
                        <span className="required"><span style={{color: "black", fontWeight: "normal"}}>Sponsor Phone</span>*</span>
                            <Inputs className="input-spacing" placeholder='Sponsor Phone' TextVal={this.props.info.sponsorPhone} callback={this.props.callback} idVal={'sponsorInformation-sponsorPhone-input'} />
    ...
    >
        ...
        <option value="other">other</option>
                        ...
                        <span className="required"><span style={{color: "black", fontWeight: "normal"}}>File Number</span>*</span>
                            <Inputs className="input-spacing" placeholder='File Number' TextVal={this.props.info.fileNo} callback={this.props.callback} idVal={'sponsorInformation-fileNo-input'} />
    ...
    >
        ...
        <option value="nonethiopia">Non-Ethiopia</option>
