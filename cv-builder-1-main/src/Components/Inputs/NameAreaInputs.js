...
class NameArea extends Component {
                ...
                <h3 style={{marginBottom: 20}}>Personal Information</h3>
                    <div className="grid-3-col">
                        ...
                        <span className="required"><span style={{color: "black", fontWeight: "normal"}}>First Name</span>*</span>
                            <Inputs className="input-spacing" placeholder='First Name' TextVal={this.props.info.name} callback={this.props.callback} idVal={'personalInfo-name-input'} />
                        ...
                        <span className="required"><span style={{color: "black", fontWeight: "normal"}}>Middle Name</span>*</span>
                            <Inputs className="input-spacing" placeholder='Middle Name' TextVal={this.props.info.middleName} callback={this.props.callback} idVal={'personalInfo-middleName-input'} />
                        ...
                        <span className="required"><span style={{color: "black", fontWeight: "normal"}}>Date Of Birth</span>*</span>
                            <Inputs type="date" className="input-spacing" placeholder='Date Of Birth' TextVal={this.props.info.dateOfBirth} callback={this.props.callback} idVal={'personalInfo-dateOfBirth-input'} />
                        ...
                        <span className="required"><span style={{color: "black", fontWeight: "normal"}}>Age</span>*</span>
                            <Inputs type="number" className="input-spacing" placeholder='Age' TextVal={this.props.info.age} callback={this.props.callback} idVal={'personalInfo-age-input'} />
    ...
    { this.props.info.religion === "Religion" && this.props.info.emptyfield === true ? <div style={{color: "red"}}>this field is required</div> : ""}
                        ...
                        <span className="not-required">Own Phone Number</span>
                            <Inputs type="number" className="input-spacing" placeholder='own Phone Number' TextVal={this.props.info.ownPhoneNumber} callback={this.props.callback} idVal={'personalInfo-ownPhoneNumber-input'} />
                        ...
                        <span className="not-required">Contact Phone Number</span>
                            <Inputs type="number" className="input-spacing" placeholder='contact Phone Number' TextVal={this.props.info.contactPhoneNumber} callback={this.props.callback} idVal={'personalInfo-contactPhoneNumber-input'} />
                        ...
                        <span className="not-required">Passport Issue Place</span>
                            <Inputs className="input-spacing" placeholder='Passport Issue Place' TextVal={this.props.info.passportIssuePlace} callback={this.props.callback} idVal={'personalInfo-passportIssuePlace-input'} />
